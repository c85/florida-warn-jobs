...
def send_email(filtered_row_count, sender_email, receiver_email, body):
    if filtered_row_count == 0:
        logging.info(f"Returned {filtered_row_count} record(s), no matches found.")
    else:
        logging.info(f"Returned {filtered_row_count} record(s) that matched, please review!")
        msg = MIMEText(body)
